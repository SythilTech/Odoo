...
class SupportTicketController(http.Controller):
    ...
    def support_portal_ticket_comment(self, **kw):
        ...
        request.env['website.support.ticket'].sudo().browse(support_ticket.id).message_post(body=values['comment'], subject="Support Ticket Reply", message_type="comment", subtype="mail.mt_comment", attachments=attachments)
