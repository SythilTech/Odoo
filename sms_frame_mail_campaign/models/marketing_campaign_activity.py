...
class MarketingCampaignSms(models.Model):
	...
	my_sms = self.env[sms_template.from_mobile_verified_id.account_id.account_gateway_id.gateway_model_name].send_message(sms_template.from_mobile_verified_id.account_id.id, sms_template.from_mobile_verified_id.mobile_number, rendered_sms_to, rendered_sms_template_body, workitem.object_id.model, workitem.res_id, sms_template.media_id)
