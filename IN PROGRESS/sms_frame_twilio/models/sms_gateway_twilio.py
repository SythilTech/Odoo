...
class SmsGatewayTwilio(models.Model):
    ...
    def send_message(self, from_number, to_number, sms_content, my_model_name='', my_record_id=0):
	...
	if sms_message.find('Status').text == "failed":
	    ...
	    target = find_owner_model(my_message)
