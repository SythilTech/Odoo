...
class WebsiteSupportTicketInheritAccountAnalyticLine(models.Model):
    ...
    state_id = fields.Many2one('website.support.ticket.state', readonly=True, related="support_ticket_id.state_id", string="State")
    ...
    total_hours = fields.Float(string='Total', related="task_id.total_hours_spent", help="Computed as: Time Spent + Remaining Time.")
