...
class VoipCall(models.Model):
    ...
    status = fields.Selection([('missed','Missed'), ('pending','Pending'), ('active','Active'), ('over','Over'), ('rejected','Rejected')], string='Status', default="precall", help="Pending = Calling person\nActive = currently talking")
